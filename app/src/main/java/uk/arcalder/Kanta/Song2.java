...
public class Song2 {
    ...
    // CONSTRUCTOR
    public Song2(String AUDIO_ID, String TITLE, String ALBUM_KEY, String ALBUM, String ARTIST_KEY, String ARTIST, Long SONG_GENRE_ID, String SONG_GENRE_TITLE, int SONG_YEAR, int SONG_TRACK_NUM, Long SONG_DURATION, String SONG_DATA) {
        this.AUDIO_ID = AUDIO_ID;        // ID associated with track
