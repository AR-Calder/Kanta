...
public class MusicProvider {
    ...
    * */
    ...
    private ArrayList<Song> songQuery(int limit, int offset, @NonNull String songSELECTION) {
        ...
        // Query
        try (Cursor songCursor = this.contentResolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, songColumns, songSELECTION, null, MediaStore.Audio.Media.DEFAULT_SORT_ORDER)) {
    ...
    public Song getSongByKey(String key) {
        ...
        // Only accept music files
        String songSELECTION = MediaStore.Audio.Media.IS_MUSIC + "=1 and " + MediaStore.Audio.Media.TITLE_KEY + "=" + key;
    ...
    public Song getSongById(String id){
        // Only accept music files
        String songSELECTION = MediaStore.Audio.Media.IS_MUSIC + "=1 and " + MediaStore.Audio.Media._ID + "=" + id;
    ...
    public ArrayList<Song> getSongsByArtistKey(String key) {
        ...
        // Only accept music files
        String songSELECTION = MediaStore.Audio.Media.IS_MUSIC + "=1 and " + MediaStore.Audio.Media.ARTIST_KEY + "=" + key;
    ...
    public ArrayList<Song> getSongsByAlbumKey(String key) {
        ...
        // Only accept music files
        String songSELECTION = MediaStore.Audio.Media.IS_MUSIC + "=1 and " + MediaStore.Audio.Media.ALBUM_KEY + "=" + key;
    ...
    * */
    ...
    private ArrayList<Album> albumQuery(int limit, int offset, @NonNull String albumSELECTION) {
        ...
        // Query
        try (Cursor albumCursor = this.contentResolver.query(MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI, albumColumns, albumSELECTION, null, MediaStore.Audio.Albums.DEFAULT_SORT_ORDER)) {
    ...
    public Album getAlbumByArtistName(String name) {
    ...
    // TODO GET ALBUMS BY ARTIST name
    public ArrayList<Album> getAlbumsByArtistName(String name) {
    ...
    * */
    ...
    private ArrayList<Artist> artistQuery(int limit, int offset, @NonNull String artistSELECTION) {
        ...
        // Query
        try (Cursor artistCursor = this.contentResolver.query(MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI, artistColumns, artistSELECTION, null, MediaStore.Audio.Albums.DEFAULT_SORT_ORDER)) {
    ...
    public Artist getArtistByKey(String key) {
        // Only accept albums that match artist key
        String artistSELECTION = MediaStore.Audio.Artists.ARTIST_KEY + "=" + key;
    ...
    public Artist getArtistById(String id) {
        // Only accept albums that match artist key
        String artistSELECTION = MediaStore.Audio.Artists._ID + "=" + id;
    ...
    * */
    ...
    private ArrayList<Genre> genreQuery(int limit, int offset, @NonNull String genreSELECTION) {
        ...
        // Query
        try (Cursor genreCursor = this.contentResolver.query(MediaStore.Audio.Genres.EXTERNAL_CONTENT_URI, genreColumns, genreSELECTION, null, MediaStore.Audio.Genres.DEFAULT_SORT_ORDER)) {
    ...
    private ArrayList<Playlist> playlistQuery(int limit, int offset, @NonNull String playlistSELECTION) {
        ...
        //Query
        try (Cursor playlistCursor = this.contentResolver.query(MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI, playlistColumns, playlistSELECTION, null, MediaStore.Audio.Playlists.DEFAULT_SORT_ORDER)) {
    ...
    private ArrayList<Song> playlistSongsQuery(int limit, int offset, @NonNull String playlistSELECTION, @NonNull String songSELECTION) {
        ...
        try (Cursor thisPlaylistCursor = contentResolver.query(thisPlaylistUri, new String[]{MediaStore.Audio.Playlists.Members.TITLE_KEY}, songSELECTION, null, MediaStore.Audio.Playlists.Members.DEFAULT_SORT_ORDER)) {
            while (thisPlaylistCursor.moveToNext()) {
                ...
                songs.add(getSongById(thisPlaylistCursor.getString(thisPlaylistCursor.getColumnIndex(MediaStore.Audio.Playlists.Members.AUDIO_ID))));
            }
        }
