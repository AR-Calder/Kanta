...
//
//    // QUERY HELPER
//    private ArrayList<Song2> songQuery(int limit, int offset, @NonNull String songSELECTION) {
//        // container
//        ArrayList<Song2> songList = new ArrayList<>();
//
...
//                songCursor.getString(songCursor.getColumnIndex(MediaStore.Audio.Genres.Members.AUDIO_ID)), // TODO USE AUDIO_ID
...
//
//    // TODO GET ALL SONGS
//    public ArrayList<Song2> getAllSongs() {
//        ArrayList<Song2> songList = new ArrayList<>();
//
...
//    public ArrayList<Song2> getNSongs(int limit, int offset) {
//        ArrayList<Song2> songList = new ArrayList<>();
//
//        // Only accept music files
//        String songSELECTION = MediaStore.Audio.Genres.Members.IS_MUSIC + "=1";
...
//    public Song2 getSongByKey(String key) {
//
//        // Only accept music files
...
//    public ArrayList<Song2> getSongsByArtistKey(String key) {
//
//        // Only accept music files
...
//    public ArrayList<Song2> getSongsByAlbumKey(String key) {
//
//        // Only accept music files
...
//    public ArrayList<Song2> getSongsByGenreId(Long id) {
//
...
//    public ArrayList<Song2> getSongsByPlaylist(Long id) {
...
//    public ArrayList<Song2> getSongsByDecade(int year) {
//
...
//    private ArrayList<Song2> playlistSongsQuery(int limit, int offset, @NonNull String playlistSELECTION, @NonNull String songSELECTION) {
//        // containers
//        ArrayList<Song2> songs = new ArrayList<>();
//
//        // Attach limit and/or offset to query
//        songSELECTION = getLimitOrOffset(limit, offset, songSELECTION);
//
