...
public class RecyclerViewOnInteractionListener implements RecyclerView.OnItemTouchListener{
    // Based on code from https://mobikul.com/applying-touch-listener-recycler-view-can-perform-click-whole-item-view/
    ...
    public RecyclerViewOnInteractionListener(Context context, final RecyclerView recyclerView,
        ...
        mGestureDetector = new GestureDetectorCompat(context,new GestureDetector.SimpleOnGestureListener(){
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (null != child && null != mOnTouchActionListener) {
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2,
                ...
                try {
                    ...
                    if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                        ...
                        if (null != mOnTouchActionListener  && null != child ) {
